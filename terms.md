...
Remedies is licensed to you, not sold.

## 2. What Remedies is not

This is the most important clause here, and it is repeated in the app itself, where you have to
acknowledge it before you can use it.

- **Not a medical device.** It does not diagnose, treat or prevent anything, and no medicines
  regulator has reviewed or approved it.
- **Not medical advice.** Nothing in it is medical or pharmaceutical advice. Ask a doctor or
  pharmacist about doses, interactions, side effects and whether a medicine suits you.
- **Not verified.** The app shows the information you typed in or scanned. It does not check names,
  strengths, doses or expiry dates against any source. Read the packaging or the leaflet before
  taking anything.
- **Not reliable for time-critical doses.** Reminders are ordinary iPhone notifications. iOS can
  delay or drop them, and none arrive while the phone is off. Never let Remedies be the only thing
  standing between you and a dose that matters.
- **Not for emergencies.** In an emergency, call your local emergency number.
...
Some features are part of a paid unlock called Remedies Plus.
...
Do not decompile, resell or redistribute the app, use it to break the law, or misrepresent it as a
medical device or as a source of medical advice.
...
Nothing in these terms limits rights you have as a consumer under the law of your own country, and
nothing here excludes liability for death or personal injury caused by negligence, for fraud, or for
...
They end when you delete the app.
...
"terrorist supporting", and that you are not on any U.S. Government list of prohibited or restricted
parties.
